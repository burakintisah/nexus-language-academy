        ...
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <p className="mt-3 text-sm text-gray-300">
              Online İngilizce eğitiminde uzman kadromuzla kaliteli eğitim.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-300">
              <li>
                <a href={`tel:${common.footer.phone.replace(/\s/g, "")}`} className="flex items-center gap-2 transition-colors hover:text-white">
              ...
              <li>
                <a href={`mailto:${common.footer.email}`} className="flex items-center gap-2 transition-colors hover:text-white">
                  <svg className="h-4 w-4 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
